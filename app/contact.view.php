        ...
        <nav class="border-b border-gray-200 bg-white">
                ...
                <div class="flex h-16 justify-between">
                    <div class="flex">
                        ...
                        <div class="hidden sm:-my-px sm:ml-6 sm:flex sm:space-x-8">
                            ...
                            <a href="/contact.php" class="border-indigo-500 text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium" aria-current="page">Contact</a>
            ...
            <div class="sm:hidden" id="mobile-menu">
                <div class="space-y-1 pt-2 pb-3">
                    ...
                    <a href="/contact.php" class="bg-indigo-50 border-indigo-500 text-indigo-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium" aria-current="page">Contact</a>
